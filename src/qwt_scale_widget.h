...
public:
    ...
    enum LayoutFlag
    {
        ...
        TitleInverted = 0x01,
        /*!
          if set true, the extent of scaleWidget is set by user.
          otherwise, the extent is calculated by length of tick label.
         */
        ExtentFixed = 0x10
    };
...
public:
    ...
    const QwtText &ScaleIndexText() const;
    QSize scaleIndexSize() const;
    void drawScaleIndex( QPainter *painter,
        const QRectF &rect ) const;
